...
All analysis was conducted in Python (Van Rossum & Drake, 2009) [@python] using NumPy [@numpy],
pandas [@pandas], scikit-learn [@sklearn], Pandera (@Bantilan_2023) for data validation, Altair (@altair) for visualization, click to create all anlysis scripts (@click), and Quarto to render the report (@Allaire_Quarto_2022).
